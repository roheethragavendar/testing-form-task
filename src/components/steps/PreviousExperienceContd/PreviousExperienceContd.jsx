...
//         <thead>
//           <tr>
//             <th className="border border-slate-600 font-bold h-6 mt-3 text-gray-500 text-xs leading-5 uppercase">From (Month/Year)l</th>
...
const PreviousExperienceContd = ({ handleClick, currentStep, steps }) => {
  ...
  const validateForm = () => {
    ...
    if (Object.values(formData.table1).some(value => value === '')) {
      newErrors.table1 = "Please fill all fields in Table 1";
      isValid = false;
    }
    if (Object.values(formData.table2).every(value => value === '')) {
      newErrors.table2 = "Please fill all fields in Table 2";
      isValid = false;
    }
    if (Object.values(formData.table3).every(value => value === '')) {
      newErrors.table3 = "Please fill all fields in Table 3";
      isValid = false;
    }
  ...
  return (
    <div className="flex flex-col">
      ...
      <table className="table-auto border border-slate-500 mt-1">
        <thead>
          <tr>
            <th className="border border-slate-600 font-bold h-6 mt-3 text-gray-500 text-xs leading-5 uppercase">From (Month/Year)</th>
            <th className="border border-slate-600 font-bold h-6 mt-3 text-gray-500 text-xs leading-5 uppercase">Firm Name</th>
      ...
      <div className="font-bold h-6  text-gray-500 text-xs leading-8 uppercase">Responsibilities:</div>
      <div className="bg-white my-2 p-1 flex border border-gray-200 rounded">
        <input
          type="text"
      ...
      <div className="font-bold h-6 text-gray-500 text-xs leading-8 uppercase">Reason For Leaving:</div>
      <div className="bg-white my-2 p-1 flex border border-gray-200 rounded">
        <input
          type="text"
          className="p-1 px-2 appearance-none outline-none w-full text-gray-800"
